    ...
    fileTool.readDirectory(dir)
      .then(function(files) {
        ...
        files.forEach(function(file) {
          if ( file.fullPath.indexOf("index.html", file.fullPath.length - "index.html".length) === -1 ) {
...
module.exports.uploadFile = function(s3, ui, fullPath, params) {
  ...
  if (fileName == 'index.html' ) {
    params.CacheControl = "no-cache, must-revalidate";
    ui.writeLine(chalk.green('No Cache for index set'));
  }
